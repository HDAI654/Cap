...
class TestUserRepository:
    ...
    def test_create_user_duplicate_username(self):
        # Create first user
        UserRepo.create_user(UserEntity(
            username="duplicate",
        ...
        with pytest.raises(UserAlreadyExists, match="Username 'duplicate' is already taken"):
            UserRepo.create_user(UserEntity(
                username="duplicate",
    ...
    def test_create_user_duplicate_email(self):
        ...
        with pytest.raises(UserAlreadyExists, match="Email 'same@example.com' is already registered"):
            UserRepo.create_user(UserEntity(
                username="user2",
                email="same@example.com",
                password="pass1234"
    ...
    def test_create_user_case_insensitive_email_uniqueness(self):
        ...
        with pytest.raises(UserAlreadyExists, match="Email 'test@example.com' is already registered"):
            UserRepo.create_user(UserEntity(
                username="user2",
                email="test@example.com",
                password="pass1234"
    ...
    def test_create_user_case_insensitive_username_uniqueness(self):
        ...
        # Different case should still trigger duplicate
        with pytest.raises(UserAlreadyExists, match="Username 'testuser' is already taken"):
            UserRepo.create_user(UserEntity(
                username="testuser",
