...
class ReserveHoldingCommand:
    """Input for the reserve-holding use case."""
...
class ReserveHoldingHandler:
    """Application service that reserves shares in a wallet holding."""
    ...
    async def handle(self, command: ReserveHoldingCommand) -> None:
        ...
        async with self._uow:
            ...
            wallet.reserve_holding(instrument_id, quantity)
