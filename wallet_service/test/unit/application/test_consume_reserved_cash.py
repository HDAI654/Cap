...
async def test_consumes_reserved_cash(
    mock_uow: AsyncMock,
    ...
    handler = ConsumeReservedCashHandler(mock_uow)
    ...
    assert balance.available.amount == Decimal("120.00")
    assert balance.reserved.amount == Decimal("0.00")
