...
async def test_reserves_cash(
    ...
    handler = ReserveCashHandler(mock_uow)
    ...
    assert balance.available.amount == Decimal("125.00")
    assert balance.reserved.amount == Decimal("75.00")
